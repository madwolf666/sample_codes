...
from googleapiclient.discovery import build  # pip install google-api-python-cliet

YOUTUBE_API_KEY = "AIzaSyCp1c0VFL90k0YrfaPqEGfDUDP8Mf6twFc"  # 環境変数からAPIキーを取得する。
